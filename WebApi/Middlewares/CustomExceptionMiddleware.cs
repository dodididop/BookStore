...
namespace WebApi.Middleware
{
    public class CustomExceptionMiddleware
    {
        ...
        {
            var watch= Stopwatch.StartNew();//sistemi izlemeye başla.timer.
            try
            {
                string message = "[Request] HTTP " + context.Request.Method + " - " + context.Request.Path;//requestin ilk başladığı zaman
